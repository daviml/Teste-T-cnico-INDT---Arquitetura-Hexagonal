...
/// <summary>
/// Result pattern: representa sucesso ou falha SEM usar exceções para controle
/// de fluxo. Regras de negócio esperadas retornam <see cref="Result"/>;
/// exceções ficam reservadas para violação de invariante de domínio.
/// </summary>
public class Result
{
