...
/// <summary>
/// Classifica a natureza de uma falha de aplicação. A API traduz cada tipo
/// para o status HTTP adequado (Validação → 400, NãoEncontrado → 404,
/// Conflito → 409), mantendo o mapeamento HTTP fora do núcleo.
/// </summary>
...
/// <summary>Erro de aplicação: código estável, mensagem legível e tipo.</summary>
